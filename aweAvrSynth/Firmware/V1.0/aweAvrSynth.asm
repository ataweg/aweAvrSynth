...
ATTACKTIME:	.BYTE 1		; 0..255 read from ADC
DECAYTIME:	.BYTE 1		; 0..255 read from ADC
SUSTAINLEVEL:	.BYTE 1		; 0..255 read from ADC
RELEASETIME:	.BYTE 1		; 0..255 read from ADC
...
MIDICC:	.byte $80
	...
	.equ PWMDEPTH		= MIDICC + $0E	; Knob 1	14
...
;	.equ 			= MIDICC + $16	; Slider 1	22
;	.equ 			= MIDICC + $17	; Slider 2	23
;	.equ 			= MIDICC + $18	; Slider 3	24
;	.equ 			= MIDICC + $19	; Slider 4	25
...
startup_message:
	...
	.db	"avrSynth (c)AWe 2011", 0x0d, 0x0a
